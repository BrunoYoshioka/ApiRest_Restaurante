...
public class RestauranteDAO {
	...
	public ArrayList<Restaurante> listarTodosRestaurantes(){
		...
		// variável tipo inteiro inicia com 0 
		...
		try {
			...
			while(rs.next()) {
				...
				//cada registro passada no teste do início terá
				//que incrementar de 1 em 1 o número de registros
				NumCadastrados++;
			}
			System.out.println("Número de restaurantes cadastrados: "+NumCadastrados);
